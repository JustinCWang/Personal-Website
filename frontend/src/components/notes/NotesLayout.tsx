    ...
    items: [
        ...
        subtopics: [
          ...
          },
          {
            ...
            subtopics: [
              ...
              { name: 'Law of Total Probability', hash: 'total-probability' },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { name: '12. Hard Clustering and K-Means', hash: 'hard-clustering-and-kmeans' },
    ...
    items: [
      {
        ...
        subtopics: [
          ...
          { name: '16. Program Design Foundations', hash: 'program-design-foundations' },
        ],
      },
      {
        name: 'Intro Computer Science with Java',
        ...
        subtopics: [
          ...
          { name: '20. Linked Lists', hash: 'linked-lists' },
          { name: '21. List ADT', hash: 'list-adt' },
          { name: '22. Stack ADT', hash: 'stack-adt' },
          { name: '23. Queue ADT', hash: 'queue-adt' },
          { name: '24. Trees and Binary Trees', hash: 'trees-and-binary-trees' },
          { name: '25. Tree Traversals', hash: 'tree-traversals' },
          { name: '26. Binary Search Trees', hash: 'binary-search-trees' },
          { name: '27. Balanced Search Trees and 2-3 Trees', hash: 'balanced-search-trees-and-2-3-trees' },
          { name: '28. Heaps', hash: 'heaps' },
          { name: '29. Heap Implementation', hash: 'heap-implementation' },
          { name: '30. Priority Queues', hash: 'priority-queues' },
          { name: '31. Hash Tables', hash: 'hash-tables' },
          { name: '32. ADTs and Design Principles', hash: 'adts-and-design-principles' },
        ],
      },
      {
        name: 'C Programming',
      ...
      {
        name: 'C# and .NET MAUI',
        path: '/notes/csharp-dotnet-maui',
        subtopics: [
          { name: '1. Current .NET MAUI Stack Map', hash: 'current-dotnet-maui-stack-map' },
          { name: '2. C# Program Shape and Syntax', hash: 'csharp-program-shape-and-syntax' },
          { name: '3. Types, Values, Nullability, and Collections', hash: 'types-values-nullability-and-collections' },
          { name: '4. Properties, Fields, Methods, and Constructors', hash: 'properties-fields-methods-and-constructors' },
          { name: '5. Async, Await, Events, and Commands', hash: 'async-await-events-and-commands' },
          { name: '6. Project File, Target Frameworks, and Workloads', hash: 'project-file-target-frameworks-and-workloads' },
          { name: '7. .NET MAUI File Structure', hash: 'maui-file-structure' },
          { name: '8. XAML Fundamentals', hash: 'xaml-fundamentals' },
          { name: '9. Code-Behind and Partial Classes', hash: 'code-behind-and-partial-classes' },
          { name: '10. MVVM Architecture', hash: 'mvvm-architecture' },
          { name: '11. BindingContext, Binding Modes, and Compiled Bindings', hash: 'binding-context-binding-modes-and-compiled-bindings' },
          { name: '12. ViewModelBase and Property Change', hash: 'viewmodel-base-and-property-change' },
          { name: '13. ObservableCollection and UI Threading', hash: 'observablecollection-and-ui-threading' },
          { name: '14. Commands, Validation, and User Intent', hash: 'commands-validation-and-user-intent' },
          { name: '15. Dependency Injection and MauiProgram', hash: 'dependency-injection-and-mauiprogram' },
          { name: '16. Shell Navigation, Routes, and Parameters', hash: 'shell-navigation-routes-and-parameters' },
          { name: '17. Services, HTTP, DTOs, and Data Flow', hash: 'services-http-dtos-and-data-flow' },
          { name: '18. App Lifecycle, State, and Cancellation', hash: 'app-lifecycle-state-and-cancellation' },
          { name: '19. Resources, Styles, Layout, and Theming', hash: 'resources-styles-layout-and-theming' },
          { name: '20. Platform-Specific Code, Permissions, and Device APIs', hash: 'platform-specific-code-permissions-and-device-apis' },
          { name: '21. Testing, Debugging, and Hot Reload', hash: 'testing-debugging-and-hot-reload' },
          { name: '22. Performance, Production, and Maintainability', hash: 'performance-production-and-maintainability' },
          { name: '23. End-to-End Work Orders Example', hash: 'end-to-end-work-orders-example' },
          { name: '24. Official Reference Links', hash: 'official-reference-links' },
        ],
      },
      {
        name: 'Go',
    ...
    items: [
      {
        ...
        subtopics: [
          ...
          { name: '4. Expressions, Types, and Values', hash: 'expressions-types-and-values' },
          { name: '5. Recursion and Functional Programming', hash: 'recursion-and-functional-programming' },
          { name: '6. Lists and Pattern Matching', hash: 'lists-and-pattern-matching' },
          { name: '7. Tail Recursion', hash: 'tail-recursion' },
          { name: '8. Tuples and Records', hash: 'tuples-and-records' },
          { name: '9. Variants and Algebraic Data Types', hash: 'variants-and-algebraic-data-types' },
          { name: '10. Options and Parametric ADTs', hash: 'options-and-parametric-adts' },
          { name: '11. Recursive ADTs and Trees', hash: 'recursive-adts-and-trees' },
          { name: '12. Higher-Order Functions', hash: 'higher-order-functions' },
          { name: '13. Map, Filter, and Fold', hash: 'map-filter-and-fold' },
          { name: '14. Modules and Testing', hash: 'modules-and-testing' },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { name: '11. Web Frameworks', hash: 'web-frameworks' },
          { name: '12. React Components, Props, and State', hash: 'react-components-props-and-state' },
          { name: '13. React Hooks: useState and useEffect', hash: 'react-hooks-usestate-and-useeffect' },
          { name: '14. API Calls with Fetch and Axios', hash: 'api-calls-with-fetch-and-axios' },
          { name: '15. Styling and Component Libraries', hash: 'styling-and-component-libraries' },
          { name: '16. TypeScript', hash: 'typescript' },
          { name: '17. Next.js', hash: 'next-js' },
          { name: '18. Client-Side Rendering, Server-Side Rendering, and Hydration', hash: 'client-side-rendering-server-side-rendering-and-hydration' },
          { name: '19. Next.js Server Components, Client Components, and Server Actions', hash: 'next-js-server-components-client-components-and-server-actions' },
          { name: '20. Backend Development', hash: 'backend-development' },
          { name: '21. FastAPI and Flask', hash: 'fastapi-and-flask' },
          ...
          { name: '24. SQLAlchemy', hash: 'sqlalchemy' },
          { name: '25. Serverless Architecture', hash: 'serverless-architecture' },
          { name: '26. Git and GitHub Version Control', hash: 'git-and-github-version-control' },
          ...
          { name: '30. Testing with Jest and Pytest', hash: 'testing-with-jest-and-pytest' },
          { name: '31. Containers and Docker', hash: 'containers-and-docker' },
          { name: '32. Containerizing React Apps', hash: 'containerizing-react-apps' },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { name: '19. C Programming Basics', hash: 'c-programming-basics' },
          { name: '20. C Functions', hash: 'c-functions' },
          { name: '21. C Data Representation and Types', hash: 'c-data-representation-and-types' },
          { name: "22. Signed, Unsigned, and Two's Complement", hash: 'signed-unsigned-and-twos-complement' },
          { name: '23. C Pointers', hash: 'c-pointers' },
          { name: '24. Pointer Arithmetic and Arrays', hash: 'pointer-arithmetic-and-arrays' },
          { name: '25. C Strings', hash: 'c-strings' },
          { name: '26. Multidimensional Arrays', hash: 'multidimensional-arrays' },
          { name: '27. Dynamic Memory Allocation', hash: 'dynamic-memory-allocation' },
          { name: '28. Structs and Linked Lists', hash: 'structs-and-linked-lists' },
          { name: '29. Pointer Declarations and Operator Precedence', hash: 'pointer-declarations-and-operator-precedence' },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { name: '14. SQL Basics', hash: 'sql-basics' },
          { name: '15. SQL Pattern Matching', hash: 'sql-pattern-matching' },
          { name: '16. SQL Aggregates and GROUP BY', hash: 'sql-aggregates-and-group-by' },
          { name: '17. SQL Subqueries', hash: 'sql-subqueries' },
          { name: '18. SQL Joins and Outer Joins', hash: 'sql-joins-and-outer-joins' },
          { name: '19. SQL Data Types and Modification Commands', hash: 'sql-data-types-and-modification-commands' },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { name: '4. Goroutines, Channels, Mutexes, and Race Detection', hash: 'goroutines-channels-mutexes-and-race-detection' },
